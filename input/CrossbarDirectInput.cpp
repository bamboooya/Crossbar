...
BOOL CrossbarDirectInput::ControllerCallback(uint32_t* offset, int32_t* state, bool blocked, bool injected)
{
	...
	switch (*offset)
	{
        ...
        case 55:
            ...
            break;
        case 56:
            m_ControllerState.Share = (*state & 0x80);
            break;
        case 57:
            m_ControllerState.Option = (*state & 0x80);
            break;
        case 58:
            m_ControllerState.LeftStickPress = (*state & 0x80);
            break;
        case 59:
            m_ControllerState.LeftStickPress = (*state & 0x80);
            break;
        case 60:
            m_ControllerState.PlayStation = (*state & 0x80);
            break;
        case 61:
            m_ControllerState.TouchPadPress = (*state & 0x80);
            break;
	}
    #endif
